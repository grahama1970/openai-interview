...
uv run --extra dev python scripts/check_openapi_demo_metadata.py
...
receipt = {"schema":"openai_interview.verify.v1","status":"PASS","checks":["compileall","pytest","contracts","immutable-goal","python-standards","openapi-demo-metadata","setup-project-audit","docker-check-if-docker","terraform-check","react-data-qid-if-npm"]}
